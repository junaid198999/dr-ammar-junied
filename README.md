...
موقع احترافي ثنائي اللغة لد. عمار جنيد، أخصائي تقويم الأسنان وتجميل الفكين في المدينة المنورة. بُني باستخدام Next.js App Router وTypeScript، ويعمل كموقع ثابت سريع لا يحتاج إلى قاعدة بيانات أو متغيرات بيئة.
